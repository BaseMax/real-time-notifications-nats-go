...
func InitRoutes() *echo.Echo {
	...
	g.GET("orders/first", controllers.GetFirstQueuedOrder)
	g.POST("orders/first/done", controllers.DoneFirstQueuedOrder)
	g.POST("orders/first/cancel", controllers.CancelFirstQueuedOrder)
